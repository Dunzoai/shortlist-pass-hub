...
export default function SmartPagesPage() {
  const bullets = [
    "App-style experience without the app store",
    "All your links, hours, and updates in one place",
    "Customers get answers fast — no more repeat DMs",
  ];
      ...
      <section className="py-24 lg:py-32 flex-1">
        <Container>
          <div className="max-w-2xl">
            ...
            >
              One place for customers to get answers fast.
            </motion.p>
