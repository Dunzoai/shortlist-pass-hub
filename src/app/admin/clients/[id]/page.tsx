...
export default function EditClientPage() {
  ...
  const handleDelete = async () => {
    if (!confirm('Are you sure you want to delete this client? This will also delete all their services.')) {
      return
    }
  ...
  const handleUpdateService = async (
    csId: string,
    field: 'monthly_cost' | 'one_time_cost' | 'status',
    value: string | number
  ) => {
    const supabase = createClient()
  ...
  if (!client) {
    return (
      <div className="p-8">
        ...
        <Link href="/admin/clients" className="text-[#2E8B57] hover:underline">
          Back to Clients
        </Link>
      </div>
    )
  ...
  return (
    <div className="p-8">
      <div className="max-w-4xl">
        <div className="mb-8">
          <Link href="/admin/clients" className="text-gray-400 hover:text-white text-sm">
            ...
            <div className="bg-[#333333] rounded-lg p-6">
              ...
              {clientServices.length === 0 ? (
                <p className="text-gray-400 text-center py-8">
                  No services assigned yet. Use the dropdown above to add services.
                </p>
              ) : (
                <div className="space-y-4">
                  {clientServices.map((cs) => (
                    <div
                      key={cs.id}
                      className="bg-[#3a3a3a] rounded-lg p-4 space-y-3"
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleUpdateService(cs.id, 'monthly_cost', e.target.value)
                              }
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                handleUpdateService(cs.id, 'one_time_cost', e.target.value)
                              }
                              className="w-full pl-7 pr-3 py-1.5 bg-[#444444] border border-[#555555] rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#2E8B57]"
                            />
                          </div>
                      ...
                      <div>
                        ...
                        <select
                          value={cs.status}
                          onChange={(e) =>
                            handleUpdateService(cs.id, 'status', e.target.value)
                          }
