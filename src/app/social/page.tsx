...
export default function SocialPage() {
  const bullets = [
    "Posts, reels, and stories tailored to your brand voice",
    "Local-first strategy that connects with your community",
    "Consistent scheduling so you stay top-of-mind",
  ];
      ...
      <section className="py-24 lg:py-32 flex-1">
        <Container>
          <div className="max-w-2xl">
            ...
            >
              Consistent content that keeps you top-of-mind with your customers.
            </motion.p>
